...
// Package features provides feature gate functionality for experimental features.
package features
...
const (
	// AllowDeleteProvisioningResource allows deleting configurations while resources are provisioning.
