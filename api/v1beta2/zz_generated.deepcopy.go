...
func (in *BackendK8SConf) DeepCopyInto(out *BackendK8SConf) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BackendK8SConf.
func (in *BackendK8SConf) DeepCopy() *BackendK8SConf {
	if in == nil {
		return nil
	}
	out := new(BackendK8SConf)
	in.DeepCopyInto(out)
	return out
}
